...
function setViewMode(mode) {
  ...
  if (mode === 'earth') {
    ...
    showCesium();
    buildGalaxy();
  } else if (mode === 'localgroup' || mode === 'virgo' || mode === 'laniakea' || mode === 'sloan' || mode === 'allsky' || mode === 'hubble' || mode === 'cmb' || mode === 'andromeda' || mode === 'pisces-cetus' || mode === 'giant-arc' || mode === 'huge-lqg' || mode === 'giant-grb-ring' || mode === 'hercules-corona') {
    closeSolarSystemView();
    clearGalaxy();
