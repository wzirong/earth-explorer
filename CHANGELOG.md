...
### ✨ 本星系群视图增强 (纯真实)
- 🆕 **星系数量 73 → 150**:合并 McConnachie 2012 完整成员目录 (arXiv:1204.1562, 101 颗含银河系全部卫星 + M31 全部伴星系) + Cosmicflows-2 补充去重
- 🎯 **渲染纯净化**:仅画真实物理星系的小圆点, 去除 glow 光晕、背景星点、Delaunay 虚假连线、M31 旋臂示意

### ✨ 银河系视图替换为 NASA Spitzer 高清图
- 🆕 换为 **NASA / JPL-Caltech / R. Hurt (SSC-Caltech)** 基于 Spitzer 红外空间望远镜 (2008) 重建的银河系俯视图 (5600×5600, 4.95 MB)
- 🌟 版权: NASA 公共领域, 自由使用 (替换了原 gen_galaxy.py 程序生成的合成图)
- 📊 展示: 4 条主旋臂 (Norma / Scutum-Centaurus / Sagittarius / Perseus) + 猎户支臂 (Orion Spur) + 银河棒旋 + 银道经度/距离刻度 (15k–75k ly)
- 📍 标注位置按真实巡天调整: 银心 (52%, 40%), 太阳 (52%, 69%)
- 取代 e247d01 的 4 旋臂示意图 (该图未明示出处且为生成)

## [Unreleased] — 2026-08-28

### ✨ 新增
- 🆕 **citycost.cn 生活成本数据接入**:启动时从 https://citycost.cn/api/cities.json 拉取 10 个城市的实时生活成本数据,本地 fallback `/data/cities_cost.json`。点击地球上的中国主要城市(北京/天津/上海/成都/广州/深圳/杭州/武汉/西安/重庆),右侧面板会显示:平均月薪/一居室月租/快餐/麦当劳套餐/二手房均价/新房均价/公交月票/啤酒/卡布奇诺/住宅同比指数 等 10+ 项实时数据。面板顶部会标记 “citycost.cn (实时)” vs “本地数据” 以区分数据源。
