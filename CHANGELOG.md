...
### ✨ 银河系视图增强
- 🆕 **恢复俯视旋臂图** (e247d01 版本, NASA 艺术家概念图风格): 1280×1280, 清晰展示 4 条主旋臂 (英仙 / 猎户 / 人马 / 矩尺) + 中央棒旋结构 + H II 区域 + 尘埃带
- 💡 真实情况说明: 人类身处银河系内, 无法拍到真实俯视旋臂图 (VISTA VVV 只是银心侧视特写); 当前旋臂图基于 Spitzer/COBE 等红外巡天数据重建, 是示意风格而非真实观测
- 标题改为: '银河系 · 正面俯视示意 (4 条主旋臂)'; 太阳标注改为 '太阳 (我们在这里)'
